...
- If a subagent needs a smarter model, return to the parent instead of escalating autonomously

## Preferred research tools

- WebFetch for public pages (free, text-only)
- Agent-browser CLI for dynamic pages or auth walls
- Pdftotext for PDFs instead of the Read tool

When you keep fetching the same way repeatedly, wrap the pattern as a reusable tool
